...
const INPUT =
  "w-full rounded-xl border-2 border-linea dark:border-linea-dark bg-surface dark:bg-surface-dark " +
  "px-3 py-2.5 text-sm font-bold text-titulo dark:text-titulo-dark outline-none " +
        ...
        {filas.map((f, i) => (
          <div key={f.oficina} className="px-5 py-6">
            ...
            <button
              ...
              className="mt-4 inline-flex items-center gap-1.5 rounded-xl bg-oficina px-4 py-2.5 text-sm font-black text-white shadow-[0_4px_0_var(--color-oficina-fuerte)] active:shadow-[0_0_0_var(--color-oficina-fuerte)] active:translate-y-0.5 transition-all disabled:opacity-50"
            >
              {guardando === f.oficina
