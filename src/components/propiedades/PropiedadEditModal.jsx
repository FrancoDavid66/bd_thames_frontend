...
import { updatePropiedad, fetchPropiedades } from '../../store/slices/propiedadesSlice';

const PropiedadEditModal = ({ isOpen, propiedad, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    await dispatch(updatePropiedad(formData));
...
export default PropiedadEditModal;
