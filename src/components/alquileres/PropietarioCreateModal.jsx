// src/components/alquileres/PropietarioCreateModal.jsx

import { useState } from 'react'
import { useDispatch } from 'react-redux'
import { createPropietario, fetchPropietarios } from '../../store/slices/alquileresSlice'
import ModalWrapper from '../comunes/ModalWrapper'

const PropietarioCreateModal = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault()
    await dispatch(createPropietario(form))
  ...
  return (
    <ModalWrapper isOpen={isOpen} onClose={onClose} title="Nuevo Propietario">
...
export default PropietarioCreateModal
