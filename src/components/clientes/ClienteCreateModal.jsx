// src/components/clientes/ClienteCreateModal.jsx
              ...
              <div className="flex items-center justify-between px-5 pt-4 pb-3 border-b border-gray-900/80">
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-0.5">
                    Completá los datos básicos para registrar al cliente
                  </p>
                </div>
                <button
                  type="button"
              ...
              >
                  ...
                  {camposOrdenados.map((key) => (
                    ...
                    >
                      ...
                      <input
                        ...
                        className="h-11 w-full rounded-lg bg-gray-900/80 border border-gray-800 px-3 text-sm text-white placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
                ...
                <div className="flex justify-end gap-3 pt-3 border-t border-gray-900/80 mt-1">
                  ...
                  <motion.button
                    ...
                    disabled={loading}
                    className="px-4 h-10 rounded-lg bg-emerald-500 text-sm font-medium text-white hover:bg-emerald-600 disabled:opacity-60 disabled:cursor-not-allowed"
                  >
