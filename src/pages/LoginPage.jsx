  ...
  return (
    <div className="relative flex h-screen items-center justify-center overflow-hidden bg-[#030712] text-zinc-100">
      ...
      <motion.form 
        ...
        initial="hidden"
        animate="visible"
        className="relative z-10 w-full max-w-md p-8 sm:p-10 bg-white/[0.03] backdrop-blur-2xl shadow-2xl rounded-3xl border border-white/[0.08]"
      >
        <motion.div variants={itemVariants} className="text-center mb-10">
            <div className="flex justify-center mb-6">
              ...
              <motion.a 
                ...
                className="flex h-20 w-20 items-center justify-center p-2 rounded-2xl bg-white/5 border border-white/10 shadow-lg shadow-blue-500/20 backdrop-blur-md cursor-pointer z-50"
                animate={{ y: [-5, 5, -5] }} // Animación de flote constante
                transition={{ 
                  y: {
                    duration: 3, 
                    repeat: Infinity, 
            ...
            <motion.div variants={itemVariants} className="relative">
                ...
                <div className="relative">
                  ...
                  <input 
                      ...
                      className="w-full pl-11 pr-4 py-3.5 bg-black/40 border border-white/10 rounded-2xl text-white placeholder-zinc-600 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all backdrop-blur-md"
                      value={username}
            ...
            <motion.div variants={itemVariants} className="relative">
                ...
                <div className="relative">
                  ...
                  <input 
                      type="password" 
                      placeholder="••••••••" 
                      className="w-full pl-11 pr-4 py-3.5 bg-black/40 border border-white/10 rounded-2xl text-white placeholder-zinc-600 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500/50 transition-all backdrop-blur-md"
                      value={password}
